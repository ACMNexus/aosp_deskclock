...
public class AlarmClockFragment extends DeskClockFragment implements
    ...
    public class AlarmItemAdapter extends CursorAdapter {
        ...
        public void bindView(final View view, Context context, final Cursor cursor) {
            ...
            itemHolder.clock.setOnClickListener(new OnClickListener() {
                @Override
            ...
            if (daysOfWeekStr != null && daysOfWeekStr.length() != 0) {
                ...
                labelSpace = "  ";
                itemHolder.daysOfWeek.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        expandAlarm(itemHolder, true);
                        itemHolder.alarmItem.post(mScrollRunnable);
        ...
        private void bindExpandArea(final ItemHolder itemHolder, final Alarm alarm) {
            ...
            itemHolder.repeat.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            for (int i = 0; i < 7; i++) {
                ...
                itemHolder.dayButtonParents[i].setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View view) {
